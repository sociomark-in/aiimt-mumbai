...
<head>
    ...
    <link href="<?= get_template_directory_uri() ?>/assets/css/flaticon-set.css" rel="stylesheet" />
    <link href="<?= get_template_directory_uri() ?>/assets/css/elegant-icons.css" rel="stylesheet" />
    ...
    <link href="<?= get_template_directory_uri() ?>/assets/css/animate.css" rel="stylesheet" />
    <link href="<?= get_template_directory_uri() ?>/assets/css/bootsnav.css" rel="stylesheet" />
...
<body>
        ...
        <nav class="navbar mobile-sidenav inc-shape navbar-sticky navbar-default validnavs dark">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="navbar-brand-left">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/logo.png" class="logo" alt="Logo">
                        </a>
                    </div>
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="index-7.html">Home Version Serven</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="index-onepage.html">Home Version One</a></li>
                                        <li><a href="index-2-onepage.html">Home Version Two</a></li>
                                        <li><a href="index-3-onepage.html">Home Version Three</a></li>
                                        <li><a href="index-4-onepage.html">Home Version Four</a></li>
                                        <li><a href="index-5-onepage.html">Home Version Five</a></li>
                                        <li><a href="index-6-onepage.html">Home Version Six</a></li>
                                        <li><a href="index-7-onepage.html">Home Version Seven</a></li>
                                        <li><a href="index-8-onepage.html">Home Version Eight</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="side">
                    ...
                    <div class="widget">
                        <div class="logo">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/logo-dark.png" alt="Logo">
                        </div>
                    </div>
                    <div class="widget">
                        <h4 class="title">Users Pages</h4>
                        <div class="profile-thumb">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/team/6.jpg" alt="Profile">
                        </div>
                        <ul>
        ...
        <div id="bootcarousel" class="carousel slide animate_text carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner text-light carousel-zoom">
                <div class="carousel-item active">
                    <div class="slider-thumb bg-fixed" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/banner/2.jpg);"></div>
                ...
                <div class="carousel-item">
                    <div class="slider-thumb bg-fixed" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/banner/3.jpg);"></div>
                    <div class="box-table shadow dark">
                        <div class="box-cell">
                            <div class="container">
                                <div class="row">
            ...
            <button class="carousel-control-prev left carousel-control" type="button" data-bs-target="#bootcarousel" data-bs-slide="prev">
                <i class="fa fa-angle-left"></i>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next right carousel-control" type="button" data-bs-target="#bootcarousel" data-bs-slide="next">
            ...
            <div class="about-info">
                <div class="row">
                    <div class="col-lg-6 thumb">
                        <img src="<?= get_template_directory_uri() ?>/assets/img/about.jpg" alt="Thumb">
                    </div>
    ...
    <div class="wcs-area bg-dark text-light">
        <div class="container-full">
            <div class="row">
                <div class="col-lg-6 thumb bg-cover" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/banner/16.jpg);"></div>
                ...
                <div class="featured-courses-carousel owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <div class="thumb">
                                    <img src="<?= get_template_directory_uri() ?>/assets/img/courses/f1.jpg" alt="Thumb">
                                    <div class="live-view">
                                        <a href="<?= get_template_directory_uri() ?>/assets/img/courses/f1.jpg" class="item popup-link">
                    ...
                    <div class="item">
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <div class="thumb">
                                    <img src="<?= get_template_directory_uri() ?>/assets/img/courses/f2.jpg" alt="Thumb">
                                    <div class="live-view">
                                        <a href="<?= get_template_directory_uri() ?>/assets/img/courses/f2.jpg" class="item popup-link">
                                            <i class="fa fa-camera"></i>
                                        </a>
                                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=vQqZIFCab9o">
                                            <i class="fa fa-video"></i>
                    ...
                    <div class="item">
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <div class="thumb">
                                    <img src="<?= get_template_directory_uri() ?>/assets/img/courses/f3.jpg" alt="Thumb">
                                    <div class="live-view">
                                        <a href="<?= get_template_directory_uri() ?>/assets/img/courses/f3.jpg" class="item popup-link">
                                            <i class="fa fa-camera"></i>
                                        </a>
                                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=vQqZIFCab9o">
                                            <i class="fa fa-video"></i>
                ...
                <div class="col-md-12">
                    <div class="popular-courses-items popular-courses-carousel owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?= get_template_directory_uri() ?>/assets/img/courses/1.jpg" alt="Thumb">
                                </a>
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/team/7.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?= get_template_directory_uri() ?>/assets/img/courses/2.jpg" alt="Thumb">
                                </a>
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/team/8.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                                        <a href="#">Akua Paul</a>
                                        <div class="rating">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?= get_template_directory_uri() ?>/assets/img/courses/3.jpg" alt="Thumb">
                                </a>
                                <div class="price">Price: Free</div>
                            </div>
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/team/9.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?= get_template_directory_uri() ?>/assets/img/courses/4.jpg" alt="Thumb">
                                </a>
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/team/2.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
                                        <a href="#">Huma Park</a>
                                        <div class="rating">
                        ...
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?= get_template_directory_uri() ?>/assets/img/courses/5.jpg" alt="Thumb">
                                </a>
                            ...
                            <div class="info">
                                <div class="author-info">
                                    <div class="thumb">
                                        <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/team/3.jpg" alt="Thumb"></a>
                                    </div>
                                    <div class="others">
            ...
            <div class="top-cat-items">
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 equal-height">
                        <div class="item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/category/1.jpg);">
                            <a href="#">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 equal-height">
                        <div class="item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/category/2.jpg);">
                            <a href="#">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 equal-height">
                        <div class="item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/category/3.jpg);">
                            <a href="#">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 equal-height">
                        <div class="item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/category/4.jpg);">
                            <a href="#">
                                <i class="flaticon-education"></i>
                                <div class="info">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 equal-height">
                        <div class="item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/category/5.jpg);">
                            <a href="#">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 equal-height">
                        <div class="item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/category/6.jpg);">
                            <a href="#">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 equal-height">
                        <div class="item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/category/7.jpg);">
                            <a href="#">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 equal-height">
                        <div class="item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/category/8.jpg);">
                            <a href="#">
                ...
                <div class="col-md-12">
                    <div class="advisor-items advisor-carousel-solid owl-carousel owl-theme text-center text-light">
                        ...
                        <div class="advisor-item">
                            <div class="info-box">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/advisor/1.jpg" alt="Thumb">  
                        ...
                        <div class="advisor-item">
                            <div class="info-box">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/advisor/2.jpg" alt="Thumb">  
                                <div class="info-title">
                                    <h4>Monayem Pruda</h4>
                        ...
                        <div class="advisor-item">
                            <div class="info-box">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/advisor/3.jpg" alt="Thumb">  
                                <div class="info-title">
                                    <h4>Dr. Bubly Minu</h4>
                        ...
                        <div class="advisor-item">
                            <div class="info-box">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/advisor/4.jpg" alt="Thumb">  
                                <div class="info-title">
                        ...
                        <div class="advisor-item">
                            <div class="info-box">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/advisor/5.jpg" alt="Thumb">  
                                <div class="info-title">
                                    <h4>Professon. John Doe</h4>
                                    <span>Senior Writter</span>
                                    <div class="social">
    ...
    <!-- Start Fun Factor 
    ============================================= -->
    <div class="fun-factor-area default-padding bottom-less text-center bg-fixed shadow dark-hard" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/banner/2.jpg);">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="event-items">
                ...
                <div class="item horizontal">
                    <div class="col-lg-6 thumb bg-cover" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/event/1.jpg);">
                        <div class="date">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="item vertical">
                            <div class="thumb">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/event/2.jpg" alt="Thumb">
                                <div class="date">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="item vertical">
                            <div class="thumb">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/event/3.jpg" alt="Thumb">
                                <div class="date">
                ...
                <!-- Single Item -->
                <div class="item horizontal">
                    <div class="col-lg-6 thumb bg-cover" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/event/4.jpg);">
                        <div class="date">
        ...
        <div class="container">
            <div class="row">
                <div class="reg-items">
                    ...
                    <div class="col-lg-6 thumb">
                        <img src="<?= get_template_directory_uri() ?>/assets/img/contact.png" alt="Thumb">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="clients-review-carousel owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="row align-items-center">
                        <div class="col-lg-5 thumb">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/team/2.jpg" alt="Thumb">
                        </div>
                        <div class="col-lg-7 info">
                            <p>
                ...
                <div class="item">
                    <div class="row align-items-center">
                        <div class="col-lg-5 thumb">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/team/3.jpg" alt="Thumb">
                        </div>
                        <div class="col-lg-7 info">
                            <p>
                                Procuring continued suspicion its ten. Pursuit brother are had fifteen distant has. Early had add equal china quiet visit. Appear an manner as no limits either praise.. 
                ...
                <div class="item">
                    <div class="row align-items-center">
                        <div class="col-lg-5 thumb">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/team/4.jpg" alt="Thumb">
                        </div>
                        <div class="col-lg-7 info">
                            <p>
                                Procuring continued suspicion its ten. Pursuit brother are had fifteen distant has. Early had add equal china quiet visit. Appear an manner as no limits either praise.. 
                ...
                <div class="item">
                    <div class="row align-items-center">
                        <div class="col-lg-5 thumb">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/team/7.jpg" alt="Thumb">
                        </div>
                        <div class="col-lg-7 info">
                            <p>
                                Procuring continued suspicion its ten. Pursuit brother are had fifteen distant has. Early had add equal china quiet visit. Appear an manner as no limits either praise.. 
            ...
            <div class="blog-items">
                <div class="row">
                    ...
                    <div class="col-lg-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/blog/1.jpg" alt="Thumb"></a>
                                <div class="date">
                    ...
                    <div class="col-lg-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/blog/2.jpg" alt="Thumb"></a>
                                <div class="date">
                    ...
                    <div class="col-lg-4 single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/blog/3.jpg" alt="Thumb"></a>
                                <div class="date">
                ...
                <div class="col-md-8 clients">
                    <div class="clients-items owl-carousel owl-theme text-center">
                        <div class="single-item">
                            <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/clients/1.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/clients/2.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/clients/3.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/clients/4.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/clients/5.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/clients/6.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/clients/7.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/clients/8.png" alt="Clients"></a>
                        </div>
                        <div class="single-item">
                            <a href="#"><img src="<?= get_template_directory_uri() ?>/assets/img/clients/9.png" alt="Clients"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="f-items">
                <div class="row">
                    <div class="col-lg-4 col-md-6 item">
                        <div class="f-item">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/logo-light.png" alt="Logo">
                            <p>
    ...
    <!-- jQuery Frameworks
    ============================================= -->
    <script src="<?= get_template_directory_uri() ?>/assets/js/jquery-3.7.1.min.js"></script>
    <script src="<?= get_template_directory_uri() ?>/assets/js/bootstrap.bundle.min.js"></script>
    <script src="<?= get_template_directory_uri() ?>/assets/js/jquery.appear.js"></script>
    <script src="<?= get_template_directory_uri() ?>/assets/js/jquery.easing.min.js"></script>
    ...
    <script src="<?= get_template_directory_uri() ?>/assets/js/count-to.js"></script>
    <script src="<?= get_template_directory_uri() ?>/assets/js/loopcounter.js"></script>
